                 ...
                 <div class="panel">
                        ...
                        <div class="panel-body">
                            <!-- contents -->
                               ...
                               <!-- ATENÇÃO AQUI EU ESTOU CHAMANDO O MEU COMPONENTE TAREFA -->
                        ...
                        <div class="panel-footer">
                            ...
                            <button @click="checkTodas" 
                            v-if="uncheckends.length > 0" 
                            class="btn btn-success">Concluir Todas</button>
            ...
            <div class="column col-4">
                 ...
                 <div class="panel">
                        ...
                        <div class="panel-footer">
                            ...
                            <button @click="uncheckTodas" 
                            v-if="checkeds.length > 0"  
                            class="btn btn-success"> Desmarcar Todas </button>

                            <button @click="removeTodas" 
                            v-if="checkeds.length > 0"  class="btn btn-error"> Remover Todas</button>
                            ...
                            <!-- navigation components: tabs, breadcrumbs or pagination -->
                             ...
                             <div class="input-group">
                                ...
                                <button class="btn btn-success input-group-btn ">
                                    <i class="icon icon-arrow-right"></i> Adicionar </button>
 ...
 export default { 
    ...
    name: 'App',
     ...
     components: { 
      ...
      // Ativando o Concluído e Excluir do Botões do component Display
      methods: {
          
          ...mapActions(['removeTarefa', 'toggleTarefa',  'checkTodas', 'uncheckTodas', 'removeTodas']),
      }
...
<style scoped>
    ...
    .container-board {
        ...
        padding: 15px;
        margin: 0px 100px 0px 100px; /* topo | direita | inferior | esquerda */
    }
    ...
    .input-group {
        padding: 0px 10px 0px 10px; /* topo | direita | inferior | esquerda */
    }
